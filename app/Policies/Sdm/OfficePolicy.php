...
class OfficePolicy
{
    ...
    {
        return $user->hasPermissionTo('view-office');
    }
    ...
    {
        return $user->hasPermissionTo('restore-office');
    }
    ...
    {
        return $user->hasPermissionTo('force-delete-office');
    }

    public function data(User $user): bool
    {
        return $user->hasPermissionTo('data-office');
    }
}
